...
class SearchListener
{
    ...
    private function pairSearchAndEntity(Comic $entity): array
    {
        ...
        $search->setContent(self::cleanContent($this->getComicContent($entity)));
    ...
    {
        $comicCommentary = $comic->getCommentary();
        if ($comicCommentary && !$comic->isSafe()) {
            $comicCommentary = Markdown::defaultTransform($comicCommentary);
        }
        $content = [
            $comic->getTitle(),
            $comicCommentary,
